...
def get_default_values():
    ...
    return {
        ...
        'SHOW_RATING_TMDB': lambda: True,
        'SHOW_RATING_IMDB': lambda: True,
        'SHOW_RATING_RT': lambda: True,
        'SHOW_RATING_RT_USER': lambda: True,
        'SHOW_RATING_METACRITIC': lambda: True,
        'SHOW_RATING_TRAKT_USER': lambda: True,
...
def get_config_sections():
    ...
    return {
        ...
        'advanced': ['SELECTED_USERS', 'LOG_LEVEL', 'ENABLE_BETA_FEATURES',
                     ...
                     'SHOW_RATING_TMDB', 'SHOW_RATING_IMDB', 'SHOW_RATING_RT',
                     'SHOW_RATING_RT_USER', 'SHOW_RATING_METACRITIC', 'SHOW_RATING_TRAKT_USER',
                     'SHOW_RATING_TRAKT_COMMUNITY', 'RATINGS_CACHE_TTL_HOURS',
